...
from tests.schema.users import UserTestSchema, CreateUserResponseTestSchema, GetUserResponseTestSchema
...
def assert_create_user_response(actual: CreateUserResponseTestSchema, expected: CreateUserResponseTestSchema) -> None:
...
def assert_get_user_response(
        actual: GetUserResponseTestSchema,
        expected: GetUserResponseTestSchema
) -> None:
...
def assert_create_user_response_user_with_active_debit_card_account(actual: CreateUserResponseTestSchema) -> None:
    logger.info("Check create user response. User with active debit card account")

    expected = CreateUserResponseTestSchema(
        user=UserTestSchema(
...
def assert_create_user_response_user_with_active_debit_card_account(actual: GetUserResponseTestSchema) -> None:
...
def assert_create_user_response_user_with_one_purchase_and_one_top_up_operations(actual: CreateUserResponseTestSchema) -> None:
...
def assert_create_user_response_user_with_one_purchase_and_one_top_up_operations(actual: GetUserResponseTestSchema) -> None:
