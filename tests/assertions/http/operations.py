...
from tests.schema.operations import OperationTestSchema, GetOperationsResponseTestSchema, \
    GetOperationResponseTestSchema, MakeFeeOperationRequestTestSchema, MakeFeeOperationResponseTestSchema, \
    MakeTopUpOperationResponseTestSchema, MakeTopUpOperationRequestTestSchema, MakeCashbackOperationRequestTestSchema, \
    MakeCashbackOperationResponseTestSchema, MakeTransferOperationRequestTestSchema, \
    MakeTransferOperationResponseTestSchema, MakePurchaseOperationRequestTestSchema, \
