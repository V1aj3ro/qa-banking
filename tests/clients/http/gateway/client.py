...
from tests.clients.http.event_hooks.logger_event_hook import curl_event_hook, log_request_event_hook, log_response_event_hook
...
def build_gateway_locust_http_client(environment: Environment) -> Client:
    ...
    return Client(
        ...
        event_hooks={
            "request": [log_request_event_hook, curl_event_hook],
